...
export class ApiService {
  ...
  updateLeader(id: number, leader: Partial<Leader>): Observable<{data: Leader}> {
    return this.http.put<{data: Leader}>(`${this.baseUrl}/leaders/${id}`, leader);
  }
  ...
  updateWorker(id: number, worker: Partial<Worker>): Observable<{data: Worker}> {
    return this.http.put<{data: Worker}>(`${this.baseUrl}/workers/${id}`, worker);
  }
  ...
  createProject(project: Partial<Project>): Observable<{data: Project}> {
    return this.http.post<{data: Project}>(`${this.baseUrl}/projects`, project);
  }

  updateProject(id: number, project: Partial<Project>): Observable<{data: Project}> {
    return this.http.put<{data: Project}>(`${this.baseUrl}/projects/${id}`, project);
  }
